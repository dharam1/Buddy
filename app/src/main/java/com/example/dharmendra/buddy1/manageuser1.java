...
public class manageuser1 extends AppCompatActivity {
    String user;
    ListView manageuser;
    Bundle b;
    int cidd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manageuser1);
       ...
       /** LayoutInflater inflater = LayoutInflater.from(this);
        View vv = inflater.inflate(R.layout.footer_layout1, null);
        ...
        mDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new Manage_user_adapter1(map,cidd,list,receive,send,connection,activityName,getApplicationContext());
