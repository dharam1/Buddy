...
public class ManageUserFragment extends Fragment implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,
    ...
    public static ManageUserFragment newInstance(LatLng location) {
        ManageUserFragment f = new ManageUserFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_manageuser, container, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        adapter = new HeaderAdapter(getActivity(), testData, this);
    ...
    private void moveMarker(LatLng latLng) {
        ...
        mLocationMarker = mMap.addMarker(new MarkerOptions()
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_global))
